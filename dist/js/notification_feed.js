...
var update = __webpack_require__(2)("43ee5aa2", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("48285520", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
        ...
        _c("span", { staticClass: "table-cell w-8 align-top py-4" }, [
          ...
          _vm.notification.data.level === "info"
            ? _c("span", [
                _c("img", {
                  attrs: {
                    src:
                      "https://img.icons8.com/doodle/32/000000/checklist--v1.png"
                  }
                })
              ])
            : _vm._e(),
          ...
          _vm.notification.data.level === "warning"
            ? _c("span", [
                _c("img", {
                  attrs: {
                    src: "https://img.icons8.com/color/32/000000/mamits.png"
                  }
                })
              ])
            : _vm._e(),
